...
class PlanningGraph():
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        for a2_effect_add in node_a2.action.effect_add:
            if a2_effect_add in node_a1.action.effect_rem:
                return True
    ...
    def inconsistent_support_mutex(self, node_s1: PgNode_s, node_s2: PgNode_s):
        ...
        mutually_exlusive = False
        for p1 in node_s1.parents:
            for p2 in node_s2.parents:
                if p1.is_mutex(p2) or p2.is_mutex(p1) and node_s2 not in p1.children and node_s1 not in p2.children:
                    mutually_exlusive = True
                else:
                    return False
    ...
    def h_levelsum(self) -> int:
        ...
        for goal in self.problem.goal:
            ...
            for level, s_set in enumerate(self.s_levels, 0): # s_set is a set of Pg_Node_s
                for s_node in s_set:
                    if s_node.is_pos:
